...
const getGlobalCommands = () =>
  discordClient.get(`/applications/${DISCORD_APP_ID}/commands`);

const createGlobalCommand = (command) =>
  discordClient.post(`/applications/${DISCORD_APP_ID}/commands`, command);

const deleteGlobalCommand = (commandID) =>
  discordClient.delete(`/applications/${DISCORD_APP_ID}/commands/${commandID}`);
